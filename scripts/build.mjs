...
`  "Content-Security-Policy": "default-src 'self'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src https://fonts.gstatic.com; script-src 'self'; img-src 'self' data:; connect-src 'self'; frame-src https://britbrae08.github.io; frame-ancestors 'none'; base-uri 'self'; form-action 'self' mailto:",\n` +
